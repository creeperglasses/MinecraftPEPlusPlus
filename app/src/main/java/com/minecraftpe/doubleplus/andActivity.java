...
//		}
	setContentView(R.layout.and);
		...
		WebView webView = (WebView) findViewById(R.id.and_web);
		...
		webview.loadUrl("http://helloworldcreeper.com/htmls/mpp_and.html");
		}
		webView.setDownloadListener(new WebViewDownLoadListener());
		mSwipeLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_and);
