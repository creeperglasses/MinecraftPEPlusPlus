...
public class NewsRecAdapter extends RecyclerView.Adapter<NewsRecAdapter.MasonryView>
{
	
	private List<NewsRecItem> products;
    private static RecycleItemClickListener itemClickListener;

    public NewsRecAdapter(List<NewsRecItem> list,RecycleItemClickListener clickListener) {
        products=list;
