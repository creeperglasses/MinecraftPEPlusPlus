...
import com.minecraftpe.doubleplus.ImageUtil.ImageCallback;
import com.minecraftpe.doubleplus.NewsAdapter.OnItemClickListener;
...
public class NewsMain implements OnItemClickListener  {
	...
	public NewsMain(ViewPager mViewPager,TextView mTextView,LinearLayout mLinearLayout,Context mContext,List<NewsBean> listADbeans) {
	...
	private void initADViewpager() {
		...
		// 设置适配器
		myPagerAdapter = new NewsAdapter(listADbeans);
