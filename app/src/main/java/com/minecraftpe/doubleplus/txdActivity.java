...
public class txdActivity extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
	{
		...
		WebView webView = (WebView) findViewById(R.id.txd_web);
		...
		webview.loadUrl("http://helloworldcreeper.com/htmls/mpp_txd.html");
		}
		webView.setDownloadListener(new WebViewDownLoadListener());
		mSwipeLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_txd);
